...
## $${\color{yellow}One-fold Validation Version}$$
### $${\color{red}Data Preprocess}$$
...
### $${\color{red}Hyperparameter Setting}$$
...
## $${\color{yellow}K-fold Validation Version}$$
### $${\color{red}Data Preprocess}$$
Model: [ResNet50](https://pytorch.org/vision/main/models/generated/torchvision.models.resnet50.html)<br>
Device: MPS<br>
Image Transformation:<br>
...
### $${\color{red}Training / Validation Setting}$$
